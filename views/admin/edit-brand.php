    ...
    <div class="form-main">
        ...
        <div class="card">
            ...
            <div class="media-upload-area" id="logoUploadArea" style="min-height: 120px; padding: 20px;">
                <input type="hidden" name="logo_url" id="logoUrlInput" value="<?= htmlspecialchars($brand['logo_url'] ?? '') ?>">
                ...
                <div id="logoPreview" class="media-preview-grid" style="<?= $brand['logo_url'] ? 'display: grid;' : 'display: none;' ?> grid-template-columns: 1fr; gap: 0;">
                    <div class="preview-item">
                        <img id="logoPreviewImg" src="<?= $brand['logo_url'] ? BASE_URL . '/' . $brand['logo_url'] : '' ?>" style="width: 100%; max-height: 150px; object-fit: contain;">
