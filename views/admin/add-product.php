            ...
            <div class="info-grid-2">
                <div class="form-group mb-0">
                    ...
                    <div class="input-prefix-container">
                        ...
                        <input type="number" name="base_price" class="modal-field-input" placeholder="0.00" step="0.01" required>
                    </div>
                </div>
                <div class="form-group mb-0">
                    ...
                    <div class="input-prefix-container">
                        <span class="prefix">£</span>
                        <input type="number" name="compare_price" class="modal-field-input" placeholder="0.00" step="0.01">
                    </div>
                </div>
            </div>
