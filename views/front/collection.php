...
<section class="bento-section" style="margin-top: 80px; margin-bottom: 80px; padding: 0 40px;">
    <div class="bento-grid">
        ...
        <div class="bento-item span-2-2" onclick="window.location.href='#'">
            <img src="<?= BASE_URL ?>/assets/product/product-1.jpg" alt="Vape Mods" loading="lazy">
        ...
        <div class="bento-item" onclick="window.location.href='#'">
            <img src="<?= BASE_URL ?>/assets/product/product-2.jpg" alt="E-Liquids" loading="lazy">
            <div class="bento-overlay"></div>
            <div class="bento-content">
        ...
        <!-- Item 3 (1x1) -->
        <div class="bento-item" onclick="window.location.href='#'">
            <img src="<?= BASE_URL ?>/assets/product/product-3.jpg" alt="Pod Systems" loading="lazy">
            <div class="bento-overlay"></div>
            <div class="bento-content">
        ...
        <!-- Item 4 (1x1) -->
        <div class="bento-item" onclick="window.location.href='#'">
            <img src="<?= BASE_URL ?>/assets/product/product-4.jpg" alt="Disposables" loading="lazy">
            <div class="bento-overlay"></div>
            <div class="bento-content">
        ...
        <!-- Item 5 (1x1) -->
        <div class="bento-item" onclick="window.location.href='#'">
            <img src="<?= BASE_URL ?>/assets/product/product-6.jpg" alt="New Arrivals" loading="lazy">
            <div class="bento-overlay"></div>
            <div class="bento-content">
        ...
        <!-- Item 6 (1x1) -->
        <div class="bento-item" onclick="window.location.href='#'">
            <img src="<?= BASE_URL ?>/assets/product/product-5.jpg" alt="Accessories" loading="lazy">
            <div class="bento-overlay"></div>
            <div class="bento-content">
        ...
        <div class="bento-item span-2-1" onclick="window.location.href='#'">
            <img src="<?= BASE_URL ?>/assets/product/product-8.jpg" alt="Vape Juice" loading="lazy">
            <div class="bento-overlay"></div>
            <div class="bento-content">
        ...
        <!-- Item 8 (1x1) -->
        <div class="bento-item" onclick="window.location.href='#'">
            <img src="<?= BASE_URL ?>/assets/product/product-9.jpg" alt="Sale" loading="lazy">
            <div class="bento-overlay"></div>
            <div class="bento-content">
