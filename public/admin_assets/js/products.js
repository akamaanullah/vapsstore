document.addEventListener('DOMContentLoaded', function () {
        ...
        btn.addEventListener('click', function () {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    toastr.error('Product has been deleted.');
    ...
    editBtns.forEach(btn => {
        btn.addEventListener('click', function () {
            toastr.info('Edit mode opened for product.');
        });
    });
    ...
    function updatePagination() {
        ...
        bindPaginationEvents(perPage, totalPages, totalRows);
    }

    function bindPaginationEvents(perPage, totalPages, totalRows) {
        let currentPage = 1;
